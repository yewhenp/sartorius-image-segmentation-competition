...
class MaskRCNN():
    ...
    # plug for compbtability
    def compile(self, optimizer, loss, metrics):
        return None

    def compile_model(self, learning_rate, momentum):
    ...
    def fit(self, x, epochs, validation_data, shuffle, callbacks):
        return self.train(train_dataset=x, val_dataset=validation_data, learning_rate=self.sgd_learning_rate,  epochs=epochs, 
                          layers="all", custom_callbacks=callbacks)
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        self.compile_model(learning_rate, self.config.LEARNING_MOMENTUM)
